...
5.3： 模型测试与可视化 (Testing & Evaluation)我们已在 checkpoints/ 目录下提供了所有数据集达到 SOTA 的预训练权重。要测试 RAF-DB 测试集的准确率，请运行：Bashpython rafdb_test.py --checkpoint 
      checkpoints/rafdb_acc0.8985.pth
