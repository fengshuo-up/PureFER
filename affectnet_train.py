...
def parse_args():
    ...
    parser.add_argument('--aff_path', type=str, default='D:/dataset/AffectNet', help='AffectNet dataset path.')
...
def run_training():
    ...
    model = DDCMNet(num_class=args.num_class, num_head=args.num_head)
    model.to(device)
    ...
    for epoch in tqdm(range(1, args.epochs + 1)):
        ...
        with torch.no_grad():
            ...
            if args.num_class == 7 and  acc > 0.45:
            ...
            elif args.num_class == 8 and  acc > 0.43:
                torch.save({'iter': epoch,
                            'model_state_dict': model.state_dict(),
                             'optimizer_state_dict': optimizer.state_dict(),},
